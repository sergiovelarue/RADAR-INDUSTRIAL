...
//
// V16.42 (2026-09-08) — ESTE ARCHIVO YA NO SE LLAMA DESDE LA UI.
// El cierre semanal ahora corre automáticamente en el servidor
// (Edge Function cerrar-semana-rac + pg_cron, ver
// rac_logro_estado_asesor_v1 en Supabase), reemplazando el botón
// manual "Cerrar semana" que llamaba guardarSnapshotSemanalRacV107
// desde aquí. modulo_08_ui_ranking.js ahora lee el resultado ya
// calculado directamente de Supabase, en vez de invocar
// leaderboardSemanalV107/leaderboardMensualV107/perfilRacAsesorV107
// en el navegador. Se conserva el archivo completo (no se borra,
// seguimos la convención del proyecto) por si se necesita volver a
// calcular en el cliente como respaldo o depuración — pero hoy es
// código muerto desde la interfaz.
// ============================================================
